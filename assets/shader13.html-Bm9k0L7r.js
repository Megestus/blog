...
<span class="line">}</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>:::</p>`,4))]),n[5]||(n[5]=s('<p> </p><h2 id="透混-alphabland-ab" tabindex="-1"><a class="header-anchor" href="#透混-alphabland-ab"><span>透混 AlphaBland-AB</span></a></h2><div class="image-preview"><img src="https://megestus-1309556466.cos.ap-shanghai.myqcloud.com/img/2e80d576-38f2-4bdc-964a-024245c979f5.gif" style="width:90% !important;"></div><p>用途：</p><ul><li>常用于复杂轮廓，无明确边缘的物体表现；</li><li>常用于半透明的物体表现；</li><li>一般的特效表现，打底用； 优点：</li><li>移动端性能较好；</li><li>边缘效果较好 缺点：</li><li>有排序问题；</li></ul><h4 id="步骤-1" tabindex="-1"><a class="header-anchor" href="#步骤-1"><span>步骤：</span></a></h4><ol><li>以AC作为模板，CtrlCV伺候；</li><li>修改Shader路径名；</li><li>面板参数保留： <ol><li>_MainTex：主纹理 RGB颜色 A透贴；</li></ol></li><li>修改SubShaderTags； <ol><li>Queue：渲染队列修改为对应的Transparent；</li><li>RenderType：修改为对应的Transparent；</li><li>ForceNoShadowCasting：设置为True，关闭投影；</li><li>IgnoreProjector：设置为True，不响应投射器；</li></ol></li><li>修改混合方式：Blend One/SrcAlpha OneMinusSrcAlpha；</li><li>对应声明输入参数；</li><li>输入，输出，顶点Shader，不用改；</li><li>像素Shader： <ol><li>对主纹理采样，RGB颜色 A透贴；</li><li>返回值；</li></ol></li></ol>',7)),a("details",null,[a("summary",null,[i(e,{text:"Code-view",color:"#e0dd8b"})]),n[1]||(n[1]=s(`<p>::: code-tabs#shell</p><p>@tab L13_AB.shader</p><div class="language-shader line-numbers-mode" data-highlighter="prismjs" data-ext="shader"><pre><code><span class="line">\uFEFFShader &quot;AP1/L13/L13_AB&quot;  // 自定义Shader路径</span>
<span class="line">{</span>
<span class="line">    // 材质面板参数</span>
<span class="line">    Properties {</span>
<span class="line">        _MainTex (&quot;RGB：颜色 A：透贴&quot;, 2d) = &quot;gray&quot;{}       //主纹理 RGB颜色 A透贴；</span>
...
<span class="line">    FallBack &quot;Diffuse/&quot;</span>
<span class="line">}</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>:::</p>`,4))]),n[8]||(n[8]=s('<h2 id="常用模式" tabindex="-1"><a class="header-anchor" href="#常用模式"><span>常用模式</span></a></h2><div class="image-preview"><img src="https://megestus-1309556466.cos.ap-shanghai.myqcloud.com/img/20240518115028.png" style="width:90% !important;"></div><table><thead><tr><th>公式</th><th>模式</th></tr></thead><tbody><tr><td>Blend SrcAlpha OneMinusSrcAlpha</td><td>//Normal</td></tr><tr><td>Blend OneMinusDstColor One</td><td>//Soft Additive</td></tr><tr><td>Blend DstColor Zero</td><td>// Multiply</td></tr><tr><td>Blend DstColor SrcColor</td><td>//2x Multiply</td></tr><tr><td>Blend op Min</td><td>// Darken</td></tr><tr><td>Blend One One</td><td></td></tr><tr><td>Blend op Max</td><td>// Lighten</td></tr><tr><td>Blend One One</td><td></td></tr><tr><td>Blend OneMinusDstColor One</td><td>//Screen</td></tr><tr><td>Blend One OneMinusSrcColor</td><td>//Same as above</td></tr><tr><td>Blend One One</td><td>// Linear Dodge</td></tr></tbody></table>',3))])}const b=l(c,[["render",u]]),g=JSON.parse('{"path":"/engine/unity/shader/shader13.html","title":"unity-shader-13","lang":"zh-CN","frontmatter":{"title":"unity-shader-13","description":null,"icon":"iconfont alicon-texiao5","category":"shader","tags":["shader","unity"],"date":"2024-05-18T00:00:00.000Z","cover":"https://megestus-1309556466.cos.ap-shanghai.myqcloud.com/img/20240518180223.png","head":[["meta",{"property":"og:url","content":"https:///about.md/blog/engine/unity/shader/shader13.html"}],["meta",{"property":"og:site_name","content":"Megestus"}],["meta",{"property":"og:title","content":"unity-shader-13"}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:image","content":"https://megestus-1309556466.cos.ap-shanghai.myqcloud.com/img/20240518180223.png"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2024-08-07T17:21:45.000Z"}],["meta",{"name":"twitter:card","content":"summary_large_image"}],["meta",{"name":"twitter:image:src","content":"https://megestus-1309556466.cos.ap-shanghai.myqcloud.com/img/20240518180223.png"}],["meta",{"name":"twitter:image:alt","content":"unity-shader-13"}],["meta",{"property":"article:tag","content":"shader"}],["meta",{"property":"article:tag","content":"unity"}],["meta",{"property":"article:published_time","content":"2024-05-18T00:00:00.000Z"}],["meta",{"property":"article:modified_time","content":"2024-08-07T17:21:45.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"unity-shader-13\\",\\"image\\":[\\"https://megestus-1309556466.cos.ap-shanghai.myqcloud.com/img/20240518183441.png\\",\\"https://megestus-1309556466.cos.ap-shanghai.myqcloud.com/img/20240518183454.png\\"],\\"datePublished\\":\\"2024-05-18T00:00:00.000Z\\",\\"dateModified\\":\\"2024-08-07T17:21:45.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"Megestus\\",\\"url\\":\\"https://github.com/Megestus\\"}]}"]]},"git":{"createdTime":1711204216000,"updatedTime":1723051305000,"contributors":[{"name":"Megestus","username":"Megestus","email":"2624203622@qq.com","commits":7,"url":"https://github.com/Megestus"}]},"filePathRelative":"engine/unity/shader/shader13.md","localizedDate":"2024年5月18日","excerpt":""}');export{b as comp,g as data};
