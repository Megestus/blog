...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>双击Setup.bat 这将下载引擎的二进制内容，安装先决条件，并设置虚幻文件关联。</p><p>引擎二进制文件的完整下载目前超过 18+ GiB，可能需要一些时间才能完成。后续运行将会快得多，往后只会下载新的和更新的内容。</p><div class="image-preview"><img src="https://megestus-1309556466.cos.ap-shanghai.myqcloud.com/img/202503192329458.png" style="width:100% !important;"></div><p>检查缓存文件是否生成。</p><div class="image-preview"><img src="https://megestus-1309556466.cos.ap-shanghai.myqcloud.com/img/202503200024542.png" style="width:100% !important;"></div><p> </p><h3 id="generateprojectfiles-bat生成解决方案sln" tabindex="-1"><a class="header-anchor" href="#generateprojectfiles-bat生成解决方案sln"><span>GenerateProjectFiles.bat生成解决方案sln</span></a></h3><p>运行GenerateProjectFiles.bat为引擎创建生成解决方案。这应该不到一分钟就能完成</p><div class="image-preview"><img src="https://megestus-1309556466.cos.ap-shanghai.myqcloud.com/img/202503200235538.png" style="width:50% !important;"><img src="https://megestus-1309556466.cos.ap-shanghai.myqcloud.com/img/202503200236875.png" style="width:50% !important;"></div><h3 id="初步编译引擎" tabindex="-1"><a class="header-anchor" href="#初步编译引擎"><span>初步编译引擎</span></a></h3><p>通过双击新的UE5.sln文件将项目加载到 Visual Studio 中</p><p>将解决方案配置设置为Development Editor，将解决方案平台设置为Win64，然后右键单击UE5目标并选择Build。编译可能需要 10 到 40 分钟才能完成，甚至一到两小时小时也说不定，却决于电脑的CPU。</p><div class="image-preview"><img src="https://megestus-1309556466.cos.ap-shanghai.myqcloud.com/img/202503200250007.png" style="width:100% !important;"></div><div class="image-preview"><img src="https://megestus-1309556466.cos.ap-shanghai.myqcloud.com/img/202503200915914.png" style="width:100% !important;"></div> 编译完成后，可以通过将启动项目设置为UE5并按F5开始调试，从 Visual Studio 运行编辑器。 <div class="image-preview"><img src="https://megestus-1309556466.cos.ap-shanghai.myqcloud.com/img/202503200930628.png" style="width:100% !important;"></div><p> </p><h2 id="其他优化设置" tabindex="-1"><a class="header-anchor" href="#其他优化设置"><span>其他优化设置</span></a></h2><h3 id="unrealenigine修改引擎dir" tabindex="-1"><a class="header-anchor" href="#unrealenigine修改引擎dir"><span>UnrealEnigine修改引擎Dir</span></a></h3><h4 id="ue4-更改虚幻引擎的缓存路径" tabindex="-1"><a class="header-anchor" href="#ue4-更改虚幻引擎的缓存路径"><span>UE4_更改虚幻引擎的缓存路径</span></a></h4><p>在UE4Games.uprojectdirs文件最后一行添加项目路径，像这样</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">; These folders will be searched 1 level deep in order to find projects</span>
