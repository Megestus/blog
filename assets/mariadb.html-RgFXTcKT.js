import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as e,b as a,d as i,f as l,o as r}from"./app-Kz1rVyom.js";const d={};function p(t,s){return r(),e("div",null,[s[0]||(s[0]=a("p",null,"简单理解数据库和使用。",-1)),i(" more "),s[1]||(s[1]=l(`<h2 id="前言" tabindex="-1"><a class="header-anchor" href="#前言"><span>前言</span></a></h2><p>在使用Docker时，经常碰到要为了一个容器，从而重新部署一个数据库，这样比较分散,不便于管理。可以使用MariaDB，搭配adminer进行数据库管理。</p><p>MariaDB数据库管理系统是MySQL的一个分支，主要由开源社区在维护，采用GPL授权许可 MariaDB的目的是完全兼容MySQL，包括API和命令行。</p><ul><li>数据库结构可以理解为- 文件夹和Excel表格文件的关系<br> 层级如下：</li></ul><div class="language-file line-numbers-mode" data-highlighter="prismjs" data-ext="file"><pre><code><span class="line">.</span>
<span class="line">├── .MariaDB</span>
<span class="line">│    └── MySQL   (Excel表格-数据库1)</span>
<span class="line">│    └── MySQL2  (Excel表格-数据库2)</span>
<span class="line">.</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>每个数据库都可以为其添加用户和密码，这样就能单独访问某一个数据库。</p><p> </p><h2 id="安装mariadb-adminer" tabindex="-1"><a class="header-anchor" href="#安装mariadb-adminer"><span>安装MariaDB+Adminer</span></a></h2><h3 id="mariadb-adminer-stack" tabindex="-1"><a class="header-anchor" href="#mariadb-adminer-stack"><span>MariaDB+Adminer Stack</span></a></h3><blockquote><p>将配置中的 ROOT_ACCESS_PASSWORD 替换成要给 root 用户设置的密码。</p></blockquote><div class="language-compose line-numbers-mode" data-highlighter="prismjs" data-ext="compose"><pre><code><span class="line">---</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p> </p><h2 id="adminer管理数据库" tabindex="-1"><a class="header-anchor" href="#adminer管理数据库"><span>Adminer管理数据库</span></a></h2><p>一键部署完成后，使用 <code>http://nas-ip:8080</code> , 访问 adminer 的应用界面。 (<code>nas-ip</code>换成你的本地ip)</p><p>初次登录信息如下：</p><ul><li>系统：MYSQL</li><li>服务器：mariadb</li><li>用户名：root</li><li>密码：配置文件中 MYSQL_ROOT_PASSWORD 项的值</li></ul><h3 id="创建数据库" tabindex="-1"><a class="header-anchor" href="#创建数据库"><span>创建数据库</span></a></h3><div class="image-preview"><img src="https://megestus-1309556466.cos.ap-shanghai.myqcloud.com/img/20240224203741.png" style="width:95% !important;"></div><p>校对： utf8mb4_general_cI （可存储表情数据）</p><h3 id="创建数据库用户" tabindex="-1"><a class="header-anchor" href="#创建数据库用户"><span>创建数据库用户</span></a></h3><div class="image-preview"><img src="https://megestus-1309556466.cos.ap-shanghai.myqcloud.com/img/20240224175241.png" style="width:95% !important;"></div><h3 id="password-hash-should-be-a-41-digit-hexadecimal-number" tabindex="-1"><a class="header-anchor" href="#password-hash-should-be-a-41-digit-hexadecimal-number"><span>Password hash should be a 41-digit hexadecimal number</span></a></h3><p>在设置密码时以上报错：Password hash should be a 41-digit hexadecimal number 原因是：输入的密码是明文，它要求你输入十六进制数字。</p><p>解决方法：</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">select password(&#39;密码&#39;)</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><p>用上方代码-替换<code>密码</code>,然后使用SQL命令-执行<br> 得到对应的十六进制码,再用十六进制码代替明文密码。</p><div class="image-preview"><img src="https://megestus-1309556466.cos.ap-shanghai.myqcloud.com/img/20240224180420.png" style="width:95% !important;"></div><div class="image-preview"><img src="https://megestus-1309556466.cos.ap-shanghai.myqcloud.com/img/20240224180126.png" style="width:95% !important;"></div><p> </p><h2 id="docker-compose遇到容器需要绑定的数据库环境描述" tabindex="-1"><a class="header-anchor" href="#docker-compose遇到容器需要绑定的数据库环境描述"><span>docker compose遇到容器需要绑定的数据库环境描述</span></a></h2><p>那么就按下方注释的信息去创建数据库和用户与密码</p><div class="language-compose line-numbers-mode" data-highlighter="prismjs" data-ext="compose"><pre><code><span class="line">容器A:</span>
